...
function validarFormulario(e) {
    ...
    if (terminoBusqueda === '') {
        mostrarAlerta('El campo "Término" es obligatorio para la búsqueda')
    }
...
function buscarImagenes() {
    ...
    const key = '28484710-6ec4ef826539728c6f9d7f81f'
            ...
            <div class="bg-white">
             <img class="w-full" src="${previewURL}">
                ...
                <div class="p-4">
                    ...
                    <a class="block w-full bg-blue-800 hover:bg-blue text-white uppercase font-bold text-center rounded mt-5 p-1"
